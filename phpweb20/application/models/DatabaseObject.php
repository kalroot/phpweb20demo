<?php
    ...
    abstract class Model_DatabaseObject
    {
        ...
        public static function BuildMultiple($db, $class, $data)
        {
            ...
            if (!$testObj instanceof Model_DatabaseObject)
                throw new Exception('Class does not extend from Model_DatabaseObject');
