...
class Model_DatabaseObject_User extends Model_DatabaseObject
{
	...
	public function __construct($db)
	{
		...
		$this->profile = new Model_Profile_User($db);
	}
	...
	public function sendEmail($tpl)
	{
		...
		$mail = new Zend_Mail();
		$mail->addTo($this->profile->email, trim($this->profile->first_name . ' ' . 
	...
	public static function GetUsers($db, $options = array())
    {
        ...
        // turn data into array of Model_DatabaseObject_User objects
        ...
        {
            if (array_key_exists($user_id, $profiles) && $profiles[$user_id] instanceof Model_Profile_User)
            {
